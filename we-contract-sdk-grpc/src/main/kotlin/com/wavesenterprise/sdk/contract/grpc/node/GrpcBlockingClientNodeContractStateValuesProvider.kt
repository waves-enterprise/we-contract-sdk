package com.wavesenterprise.sdk.contract.grpc.node
...
class GrpcBlockingClientNodeContractStateValuesProvider(
    private val contractService: ContractService,
) : NodeContractStateValuesProvider {

    override fun getForKey(contractId: ContractId, key: String): Optional<DataEntry> =
        Optional.ofNullable(contractService.getContractKey(ContractKeyRequest(contractId, key)))
