...
import my.sample.java8.contract.rockps.domain.game.AnswerType;
...
class RockPaperScissorsContractTest {
    ...
    public void shouldCreateGame() {
        ...
        Set<String> playerAddresses = testState.get(PLAYER_ADDRESSES_KEY, new TypeReference<Set<String>>() {
        });
